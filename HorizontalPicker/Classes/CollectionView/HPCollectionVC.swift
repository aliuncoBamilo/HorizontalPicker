...
class HPCollectionVC: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    func sizeForText (text: String, maxSize: CGSize) -> CGSize {
        var frame = (text as NSString).boundingRect(with: maxSize, options: .usesLineFragmentOrigin, attributes: [NSAttributedStringKey.font : font], context: NSStringDrawingContext())
